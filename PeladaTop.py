...
st.markdown(
    ...
    .stButton>button:hover { background-color: #388E3C; color: #fff; }
    ...
    .fila { background-color: #F5F5F5; }  /* cinza claro */

    /* Mensagens */
    .stSuccess { background-color: #C8E6C9; color: #1B5E20; border-radius: 5px; padding: 8px; }
    .stWarning { background-color: #FFF9C4; color: #F57F17; border-radius: 5px; padding: 8px; }

    textarea, input {
    background-color: #eeeeee !important; /* fundo cinza claro */
    color: #212121 !important;            /* texto digitado em cinza escuro */
